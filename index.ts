...
export default defineToolPlugin({
  ...
  tools: (tool) => [
    ...
    tool({
      ...
      description:
        "Fetch a public HTTP(S) URL through OpenClaw's SSRF guard and return bounded page metadata, passive software/framework/OS fingerprint hints, an untrusted excerpt, and an opt-in packet summary when container capture is configured.",
    ...
    tool({
      ...
      description:
        "Run bounded OSINT recon by effort level: light extracts indicators, medium enriches URLs/domains with URL fingerprints and optional packet summaries, high runs the broader safe lookup suite.",
